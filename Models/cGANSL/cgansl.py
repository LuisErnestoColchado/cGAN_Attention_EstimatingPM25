            ...
            for i in range(1, self.num_epoch+1):
                for batch_data in train_loader:
                    ...
                    for _ in range(self.g_steps):
                        ...
                        valid = FloatTensor(11, 1).fill_(1.0)
                        fake = FloatTensor(11, 1).fill_(0.0) 
                        ...
                        #print(indeces_labeled)
                        #!!!fake_data_labeled = fake_data[indeces_labeled].T
                        ...
                        #   print(fake_data_labeled)                        
                        fake_input_discriminator = torch.cat((fake_data_labeled, condition_labeled), dim=1)#torch.cat((fake_data_labeled, condition_labeled), -1)
                        
                        #print(fake_input_discriminator.shape)
                    ...
                    for _ in range(self.d_steps):
                        ...
                        x_real_labeled = x_real[indeces_labeled].reshape(len(x_real[indeces_labeled]), 1)
                        #print(x_real_labeled.shape, condition_labeled.shape)
                        real_input_discriminator = torch.cat((x_real_labeled, condition_labeled), dim=1)
